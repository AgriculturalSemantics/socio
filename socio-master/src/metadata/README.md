 ...
 * [socio.yml](socio.yml)
     * Determines how your purl.obolibrary.org/obo/socio/ redirects will be handled
     ...
     * Paste in the contents of [socio.yml](socio.yml)
 ...
 * [socio.md](socio.md)
     ...
     * Paste in the contents of [socio.md](socio.md)
     * Click "Commit new file"
     * IMPORTANT: remember to make a pull request
     * An OBO admin will merge your Pull Request *providing it meets the requirements of the OBO library*
